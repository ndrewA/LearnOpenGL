...
//
//#include "ECS/List/ListSorting.h"
//#include "ECS/ArchetypeGraphManager.h"
//
...
//int main()
//{
//    ArchetypeGraphManager test;
//    //test.addComponent<c1>({ 1 });
//    std::cout << Identifier<c1, c2, c3, c4>::value << '\n';
//    std::cout << Identifier<c1, c3, c2, c4>::value << '\n';
//    std::cout << Identifier<c4, c3, c2, c1>::value << '\n';
//    std::cout << Identifier<c2, c1, c3>::value << '\n';
//    std::cout << Identifier<c4, c3, c1>::value << '\n';
//    std::cout << Identifier<c3        >::value << '\n';
//    std::cout << Identifier<c3, c2, c1>::value << '\n';
//
//    return 0;
//    Application app;
//    app.run();
